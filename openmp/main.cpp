...
// Función para convertir a escala de grises en paralelo con OpenMP
void convertToGrayscaleParallel(const Mat &colorImage, Mat &grayscaleImage)
{
...
int main(int argc, char **argv)
{
    ...
    cout << "\nConvirtiendo imagen a escala de grises con " << numThreads << " hebras utilizando OpenMP..." << endl;

    // Llamar a la función de conversión paralela
    convertToGrayscaleParallel(image, grayscaleImage);
